...
float pixels_wall1[] = { //tekstura o wymiarach 2x2; dla kazdego punktu okreslone skladowe RGB koloru 
	1.0f, 5.0f, 1.0f,   0.1f, 0.1f, 0.1f,	0.1f, 0.1f, 0.1f,
	10.1f, 0.1f, 0.1f,   1.0f, 1.0f, 1.0f,	0.1f, 0.1f, 0.1f,
	0.1f, 0.1f, 13.1f,   1.0f, 1.0f, 1.0f,	0.1f, 0.1f, 0.1f,
};
...
2.0f, 0.0f,
2.0f, 2.0f,
0.0f, 2.0f, // prawy gorny rog tekstury
};


float pixels_wall2[] = { //tekstura o wymiarach 2x2; dla kazdego punktu okreslone skladowe RGB koloru 
	1.0f, 1.0f, 1.0f,   0.1f, 0.1f, 0.1f,	0.1f, 0.1f, 0.1f,
	5.1f, 0.1f, 0.1f,   12.0f, 1.0f, 1.0f,	10.1f, 0.1f, 0.1f,
	0.1f, 4.1f, 0.1f,   1.0f, 1.0f, 1.0f,	0.1f, 0.1f, 0.1f,
};
...
float pixels_wall3[] = { //tekstura o wymiarach 2x2; dla kazdego punktu okreslone skladowe RGB koloru 
	1.0f, 1.0f, 1.0f,   0.1f, 0.1f, 0.1f,	5.1f, 0.1f, 0.1f,
	0.1f, 0.1f, 0.1f,   5.0f, 1.0f, 4.0f,	2.1f, 0.1f, 0.1f,
	0.1f, 0.1f, 0.1f,   1.0f, 1.0f, 4.0f,	3.1f, 0.1f, 0.1f,
...
void configure_texture()
{
	...
	// ustawienia parametrow tekstury
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_LINEAR);	// sposob nakladania tekstury
...
int main(int argc, char** argv)
{
	...
	while (true)
	{
		if (SDL_PollEvent(&windowEvent))
		{
			...
			if (windowEvent.type == SDL_KEYDOWN)
			{
				...
				case SDLK_SPACE:
					...
					case SDLK_UP:
						position += glm::vec3(sin(glm::radians(angle)), 0.0f, cos(glm::radians(angle)));
						dt.x += sin(glm::radians(angle));
						dt.z += cos(glm::radians(angle));
						break;
					case SDLK_DOWN:
						position -= glm::vec3(sin(glm::radians(angle)), 0.0f, cos(glm::radians(angle)));
						dt.x -= sin(glm::radians(angle));
		...
		translationMatrix = glm::translate(glm::mat4(), dt);  		//macierz przesuniecia o zadany wektor
